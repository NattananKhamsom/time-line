      ...
      <div class="parchment-container">
        ...
        <div class="era-page">
          ...
          <div class="era-hero" data-aos="zoom-in">
            ...
            <p class="era-subtitle">Middle Ages</p>
            ...
            <div class="era-badge-hero">
              ...
              <span class="badge-title">Middle Ages</span>
            </div>
          ...
          <div class="era-content">
            ...
            <div class="content-section" data-aos="fade-up">
              ...
              <div class="intro-card">
                <p>
                  ยุคกลางเป็นช่วงเวลาหลังการล่มสลายของจักรวรรดิโรมัน
                  ยุโรปเข้าสู่สังคมศักดินา ศาสนามีบทบาทสำคัญต่อชีวิตผู้คน
                </p>

                <p>
                  สงครามครูเสด การก่อตั้งมหาวิทยาลัย
                  และการเปลี่ยนแปลงทางสังคมจากโรคระบาด
                  ล้วนเป็นเหตุการณ์สำคัญของยุคนี้
                </p>
              </div>
            ...
            <div class="content-section" data-aos="fade-up">
              ...
              <div class="image-grid">
                ...
                <div class="image-card">
                  ...
                  <div class="card-body">
                    <h3>ระบบศักดินา</h3>
                    <p>โครงสร้างสังคมที่แบ่งชนชั้นระหว่างกษัตริย์ ขุนนาง และชาวนา</p>
                  </div>
                </div>
                ...
                <div class="image-card">
                  ...
                  <div class="card-body">
                    <h3>สงครามครูเสด</h3>
                    <p>สงครามระหว่างคริสต์และมุสลิมเพื่อแย่งชิงดินแดนศักดิ์สิทธิ์</p>
                  </div>
                </div>
                ...
                <div class="image-card">
                  ...
                  <div class="card-body">
                    <h3>กาฬโรค</h3>
                    <p>โรคระบาดที่คร่าชีวิตประชากรยุโรปจำนวนมาก</p>
                  </div>
                </div>
            ...
            <div class="content-section impact-box" data-aos="flip-up">
              ...
              <div class="impact-grid">
                ...
                <div class="impact-item">
                  <strong>สังคม:</strong>
                  ระบบศักดินากำหนดโครงสร้างชนชั้นในยุโรป
                </div>

                <div class="impact-item">
                  <strong>วัฒนธรรม:</strong>
                  ศาสนาและสถาปัตยกรรมกอทิกมีอิทธิพลสูง
                </div>
...
icon:'🏰',
title:'ระบบศักดินา',
desc:'โครงสร้างสังคมแบ่งชนชั้นตั้งแต่กษัตริย์จนถึงชาวนา'
},

{
icon:'⚔️',
title:'สงครามครูเสด',
desc:'สงครามศาสนาระหว่างคริสต์และมุสลิม'
},

{
icon:'☠️',
title:'กาฬโรค',
desc:'โรคระบาดที่คร่าชีวิตผู้คนจำนวนมากในยุโรป'
}
...
year:'527',
title:'Justinian',
desc:'จักรพรรดิไบแซนไทน์รวบรวมกฎหมายโรมัน'
},

{
year:'622',
title:'Hijra',
desc:'จุดเริ่มต้นศักราชอิสลาม'
},

{
year:'1066',
title:'Norman Conquest',
desc:'วิลเลียมผู้พิชิตยึดอังกฤษ'
},

{
year:'1215',
title:'Magna Carta',
desc:'เอกสารจำกัดอำนาจกษัตริย์อังกฤษ'
},

{
year:'1347',
title:'Black Death',
desc:'โรคระบาดครั้งใหญ่ในยุโรป'
}
...
previousScore.value=await getUserEraScore(user.uid,'middle-ages')

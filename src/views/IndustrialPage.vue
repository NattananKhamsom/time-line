      ...
      <div class="parchment-container">
        ...
        <div class="era-page">
          ...
          <div class="era-hero" data-aos="zoom-in">
            ...
            <p class="era-subtitle">Industrial Revolution</p>
            ...
            <div class="era-badge-hero">
              ...
              <span class="badge-title">Industrial Age</span>
            </div>
          ...
          <div class="era-content">
            ...
            <div class="content-section" data-aos="fade-up">
              ...
              <div class="intro-card">
                <p>
                  การปฏิวัติอุตสาหกรรมเป็นจุดเปลี่ยนสำคัญของประวัติศาสตร์โลก 
                  มนุษย์เปลี่ยนจากสังคมเกษตรกรรมไปสู่สังคมอุตสาหกรรม 
                  เครื่องจักร โรงงาน และเทคโนโลยีใหม่ๆ 
                  ทำให้การผลิตเพิ่มขึ้นอย่างมหาศาล
                </p>

                <p>
                  เมืองขยายตัวอย่างรวดเร็ว เศรษฐกิจเติบโต 
                  และเป็นรากฐานของโลกสมัยใหม่ที่เราอาศัยอยู่ในปัจจุบัน
                </p>
              </div>
            ...
            <div class="content-section" data-aos="fade-up">
              ...
              <h2 class="section-label">🖼 นวัตกรรมสำคัญ</h2>
              ...
              <div class="image-grid">
                ...
                <div class="image-card">
                  ...
                  <div class="card-body">
                    ...
                    <p>เทคโนโลยีที่ทำให้โรงงานและรถไฟทำงานได้อย่างมีประสิทธิภาพ</p>
                  </div>
                </div>
                ...
                <div class="image-card">
                  ...
                  <div class="card-body">
                    <h3>ระบบโรงงาน</h3>
                    <p>การผลิตจำนวนมากแทนการผลิตด้วยแรงงานฝีมือ</p>
                  </div>
                </div>
                ...
                <div class="image-card">
                  ...
                  <div class="card-body">
                    <h3>รถไฟ</h3>
                    <p>การขนส่งที่รวดเร็ว เชื่อมโยงเมืองและเศรษฐกิจ</p>
                  </div>
                </div>
            ...
            <div class="content-section impact-box" data-aos="flip-up">
              ...
              <div class="impact-grid">
                ...
                <div class="impact-item">
                  ...
                  การผลิตจำนวนมาก ทำให้สินค้าเข้าถึงผู้คนได้มากขึ้น
                </div>

                <div class="impact-item">
                  <strong>สังคม:</strong> 
                  เกิดชนชั้นแรงงาน เมืองอุตสาหกรรม และการปฏิรูปกฎหมายแรงงาน
                </div>
            ...
            <div class="quiz-cta" data-aos="zoom-in">
              ...
              <p>
                คุณเข้าใจการปฏิวัติอุตสาหกรรมมากแค่ไหน?
              </p>
...
desc:'พลังงานหลักที่ขับเคลื่อนโรงงานและการขนส่ง'
},

{
icon:'🏭',
title:'ระบบโรงงาน',
desc:'การรวมแรงงานและเครื่องจักรไว้ในสถานที่เดียว'
},

{
icon:'🚂',
title:'การคมนาคม',
desc:'รถไฟและเรือไอน้ำทำให้การเดินทางรวดเร็วขึ้น'
}
...
desc:'เครื่องปั่นด้ายที่เพิ่มประสิทธิภาพการผลิตสิ่งทอ'
},

{
year:'1769',
title:'Steam Engine',
desc:'เจมส์ วัตต์พัฒนาเครื่องจักรไอน้ำ'
},

{
year:'1825',
title:'Railway',
desc:'รถไฟสายแรกเปิดให้บริการในอังกฤษ'
},

{
year:'1876',
title:'Telephone',
desc:'อเล็กซานเดอร์ เกรแฮม เบลล์ประดิษฐ์โทรศัพท์'
},

{
year:'1879',
title:'Light Bulb',
desc:'โทมัส เอดิสันพัฒนาหลอดไฟฟ้า'
}
...
previousScore.value=await getUserEraScore(user.uid,'industrial')

      ...
      <div class="parchment-container">
        ...
        <div class="era-page">
          ...
          <div class="era-hero" data-aos="zoom-in">
            ...
            <p class="era-subtitle">Renaissance</p>
            ...
            <div class="era-badge-hero">
              ...
              <span class="badge-title">Renaissance</span>
            </div>
          ...
          <div class="era-content">
            ...
            <div class="content-section" data-aos="fade-up">
              ...
              <div class="intro-card">
                <p>
                  ยุคฟื้นฟูศิลปวิทยาเป็นช่วงเวลาที่มนุษย์กลับมาสนใจ
                  ศิลปะ วิทยาศาสตร์ และปรัชญาของกรีกและโรมัน
                  ทำให้เกิดความก้าวหน้าทางความคิดและวัฒนธรรม
                </p>

                <p>
                  การค้นพบทางวิทยาศาสตร์ การสำรวจโลก
                  และการคิดค้นแท่นพิมพ์ ทำให้ความรู้
                  แพร่กระจายอย่างรวดเร็วและเปลี่ยนแปลงโลก
                </p>
              </div>
              ...
              <div class="image-grid">
                ...
                <div class="image-card">
                  ...
                  <div class="card-body">
                    ...
                    <p>ศิลปินเริ่มสร้างผลงานที่เน้นความสมจริงและมุมมองใหม่</p>
                  </div>
                </div>
                ...
                <div class="image-card">
                  ...
                  <div class="card-body">
                    <h3>แท่นพิมพ์</h3>
                    <p>ทำให้หนังสือและความรู้สามารถเผยแพร่สู่ผู้คนจำนวนมาก</p>
                  </div>
                </div>
                ...
                <div class="image-card">
                  ...
                  <div class="card-body">
                    <h3>การสำรวจโลก</h3>
                    <p>นักสำรวจค้นพบดินแดนใหม่และเส้นทางการค้าใหม่</p>
                  </div>
                </div>
            ...
            <div class="content-section impact-box" data-aos="flip-up">
              ...
              <div class="impact-grid">
                ...
                <div class="impact-item">
                  ...
                  ศิลปะและวรรณกรรมรุ่งเรืองอย่างมาก
                </div>

                <div class="impact-item">
                  <strong>วิทยาศาสตร์:</strong>
            ...
            <div class="quiz-cta" data-aos="zoom-in">
              ...
              <p>
                คุณเข้าใจยุคฟื้นฟูศิลปวิทยามากแค่ไหน?
              </p>
...
{
icon:'🎨',
title:'ศิลปะเรอเนซองส์',
desc:'ศิลปินสร้างผลงานที่เน้นความสมจริง มุมมอง และสัดส่วนของมนุษย์'
},

{
icon:'📚',
title:'การฟื้นฟูความรู้',
desc:'การศึกษาผลงานของกรีกและโรมันโบราณกลับมาได้รับความนิยม'
},

{
icon:'🧭',
title:'การสำรวจโลก',
desc:'นักสำรวจเดินทางค้นพบเส้นทางและดินแดนใหม่'
}
...
desc:'โยฮันเนส กูเทนเบิร์กคิดค้นแท่นพิมพ์'
},

{
year:'1492',
title:'Columbus Voyage',
desc:'คริสโตเฟอร์ โคลัมบัสเดินทางถึงทวีปอเมริกา'
},

{
year:'1503',
title:'Mona Lisa',
desc:'เลโอนาร์โด ดา วินชีเริ่มวาดภาพโมนาลิซ่า'
},

{
year:'1543',
title:'Copernicus',
desc:'โคเปอร์นิคัสเสนอทฤษฎีดวงอาทิตย์เป็นศูนย์กลางจักรวาล'
},

{
year:'1609',
title:'Galileo Telescope',
desc:'กาลิเลโอใช้กล้องโทรทรรศน์ศึกษาดาราศาสตร์'
}
...
previousScore.value=await getUserEraScore(user.uid,'renaissance')
